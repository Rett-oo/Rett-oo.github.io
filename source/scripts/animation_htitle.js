(function() {
  ...
  MESSAGES.push({
    delay: 1200,
    text: "You are on my portfolio site."
  });

  MESSAGES.push({
    delay: 2200,
    text: "Here you can see all the projects I'm working on, as well as those I plan to work on."
  });

  MESSAGES.push({
    delay: 4600,
    text: "You will be able to view the source code of projects with links to the Git-Hub repositories.."
  });
